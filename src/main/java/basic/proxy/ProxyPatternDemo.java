 ...
 * 3. Implementing the basic.proxy mode takes some more time.
 * 4. According to different using circumstances, basic.proxy mode shows different ways to implement.
 * 5. There are following circumstances for usage:
 *      a. remote basic.proxy
 *      b. virtual basic.proxy
 *      c. copy-on-write
 *      d. protect or access
 *      e. cache
 *      f. firewall
